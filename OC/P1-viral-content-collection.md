...
| 优先级 | 平台 | 采集方式 | 频率 | 备注 |
|--------|------|----------|------|------|
| 🔴 P0 | **小红书** | Browser-based 搜索+热门 | 每 6h | 图文+视频并重，与品牌调性最相关 |
| 🔴 P0 | **抖音** | Browser-based 热门榜 + 搜索 | 每 6h | 短视频爆款最多，需抓播放/点赞/评论 |
| 🟡 P1 | **B站** | API + Browser 热门/排行 | 每 12h | 中长视频参考，知识类内容多 |
| 🟡 P1 | **YouTube** | YouTube Data API v3 | 每 12h | 海外对标、先进玩法参考 |
